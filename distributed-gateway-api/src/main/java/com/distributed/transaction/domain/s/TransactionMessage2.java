package com.distributed.transaction.domain.s;
 ...
 */
@Entity
@Table(name = "transaction_message2")
@Data
@DynamicInsert
@DynamicUpdate
/*@SqlResultSetMapping(
        ...
        entities = @EntityResult(
                entityClass = TransactionMessageVo.class,
                fields = {
                        @FieldResult(name = "id", column = "id"),
                        @FieldResult(name = "version", column = "version"),
                        @FieldResult(name = "editor", column = "editor"),
                        @FieldResult(name = "creater", column = "creater"),
                        @FieldResult(name = "editTime", column = "edit_time"),
                        @FieldResult(name = "messageId", column = "messageId"),
                        @FieldResult(name = "messageBody", column = "message_body")


                }
        )
)*/
public class TransactionMessage2 {
