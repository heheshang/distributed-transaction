package com.distributed.transaction.module.message.domain;

import com.distributed.transaction.enums.convert.AreadlyDeadEnumConverter;
import com.distributed.transaction.enums.convert.MessageStatusEnumConverter;
import com.distributed.transaction.enums.convert.MsgDataTypeEnumConverter;
import com.distributed.transaction.enums.convert.NotifyDestinationNameEnumConverter;
...
public class TransactionMessageEntity implements Serializable {
    ...
    @Convert(converter = NotifyDestinationNameEnumConverter.class)
